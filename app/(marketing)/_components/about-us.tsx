...
export default function AboutUs() {
    return (
        <div className="relative bg-primary/90 p-10 rounded-lg">
            <section className="flex flex-col items-center gap-4 md:gap-6 z-1" id={SECTIONS_IDS.aboutUs}>
                <SectionHeader isWhite label="ABOUT US" title="ProjectVu turns your completed projects into a professional portfolio" />

                <P className="text-justify leading-6 text-white [text-align-last:center]">
