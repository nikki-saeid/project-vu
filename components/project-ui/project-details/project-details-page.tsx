...
export default function ProjectDetailsPage({ project, isPublic, business }: ProjectDetailsPageProps) {
    const { data } = useQuery({
    ...
    const { name, description: businessDescription, slug } = business ?? { name: '', businessDescription: '', slug: '' };

    return (
        <div className="flex flex-col md:gap-6 gap-4">
            <H4 className="font-medium tracking-normal text-2xl">{title}</H4>
            <DashboardCard title="Details" description={description}>
