...
export function LocationMarker({ location, onClick }: LocationMarkerProps) {
    return (
        ...
        >
            <div className="rounded-full flex items-center justify-center transform transition-all duration-200 bg-background text-foreground shadow-lg size-5 cursor-pointer hover:scale-110">
